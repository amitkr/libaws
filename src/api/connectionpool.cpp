...
namespace aws { 
    ...
    ConnectionPool<S3ConnectionPtr>::createConnection (
          const std::string& aAccessKeyId
    ...
    ConnectionPool<SQSConnectionPtr>::createConnection (
          const std::string& aAccessKeyId
        , const std::string& aSecretAccessKey
    ) {
    ...
    ConnectionPool<SDBConnectionPtr>::createConnection (
          const std::string& aAccessKeyId
        , const std::string& aSecretAccessKey
    ) {
